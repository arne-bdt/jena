...
public interface TripleBunch 
    ...
    */
    ...
    /**
        ...
        @return true iff the triple was added
    */
    public abstract boolean add( Triple t, int hashCode );
     ...
     */
    public abstract void addUnchecked( Triple t );
    ...
    /**
        ...
        <code>t</code> is added without checking if it is already a member.
    */
    public abstract void addUnchecked( Triple t, int hashCode );
    ...
    */
    ...
    /**
        ...
        @return true iff the triple was removed
    */
    public abstract boolean remove( Triple t, int hashCode );
    ...
    */
    public abstract void removeUnchecked( Triple t );
