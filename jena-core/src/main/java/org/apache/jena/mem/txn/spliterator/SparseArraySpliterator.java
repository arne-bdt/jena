...
public class SparseArraySpliterator<E> implements Spliterator<E> {
     ...
     */
    public SparseArraySpliterator(final E[] entries, final boolean[] deleted, final int toIndex, final Runnable checkForConcurrentModification) {
     ...
     * @param checkForConcurrentModification runnable to check for concurrent modifications
     */
    public SparseArraySpliterator(final E[] entries, final boolean[] deleted, final Runnable checkForConcurrentModification) {
    ...
    public Spliterator<E> trySplit() {
        ...
        this.pos = pos >>> 1;
        return new SparseArraySubSpliterator<>(entries, deleted, this.pos, toIndexOfSubIterator, checkForConcurrentModification);
    }
