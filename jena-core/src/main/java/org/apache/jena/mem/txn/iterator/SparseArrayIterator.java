...
public class SparseArrayIterator<E> extends NiceIterator<E> implements Iterator<E> {
    ...
    public SparseArrayIterator(final E[] entries, final boolean[] deleted,  final Runnable checkForConcurrentModification) {
        this(entries, deleted, entries.length, checkForConcurrentModification);
    }

    public SparseArrayIterator(final E[] entries, final boolean[] deleted, int toIndexExclusive, final Runnable checkForConcurrentModification) {
