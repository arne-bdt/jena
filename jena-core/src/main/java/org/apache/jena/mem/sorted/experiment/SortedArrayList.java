...
public class SortedArrayList<E> extends ArrayList<E> {
     ...
     *                                  is negative
     */
    public SortedArrayList(int initialCapacity, Comparator<E> comparator, int sizeToStartSorting) {
     ...
     */
    public SortedArrayList(Comparator<E> comparator, int numberOfElementsToStartSorting) {
        super();
        this.comparator = comparator;
     ...
     */
    public SortedArrayList(Collection<? extends E> c, Comparator<E> comparator, int numberOfElementsToStartSorting) {
        super(c);
        this.comparator = comparator;
        this.sizeToStartSorting = numberOfElementsToStartSorting;
