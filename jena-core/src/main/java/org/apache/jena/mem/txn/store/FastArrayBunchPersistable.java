 ...
 */
public abstract class FastArrayBunchPersistable implements FastTripleBunchPersistable {
    ...
    protected FastArrayBunchPersistable() {
     ...
     * @param bunchToCopy
     */
    protected FastArrayBunchPersistable(final FastArrayBunchPersistable bunchToCopy) {
