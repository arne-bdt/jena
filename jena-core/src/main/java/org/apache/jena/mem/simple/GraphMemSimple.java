 ...
 * has been fixed.
 */
public class GraphMemSimple extends GraphMemBase implements GraphWithPerform {


    private final TripleMapWithTwoKeys bySubjectAndObject = SubjectPredicateObjectMap.forSubjects();
    private final TripleMapWithTwoKeys byPredicateAndSubject = SubjectPredicateObjectMap.forPredicates();
    private final TripleMapWithTwoKeys byObjectAndPredicate = SubjectPredicateObjectMap.forObjects();

    public GraphMemSimple() {
        super();
    }
...
//                                    && sm.equals(t.getSubject()));
     ...
     * @return
     */
    private TripleMapWithTwoKeys getMapWithFewestKeys() {
...
//                                    && sm.equals(t.getSubject()));
    ...
    private static class IteratorWrapperWithRemove implements ExtendedIterator<Triple> {
        ...
        private final GraphMemSimple graphMem;
        ...
        public IteratorWrapperWithRemove(Iterator<Triple> iteratorWithNoRemove, GraphMemSimple graphMem) {
