 ...
 * has been fixed.
 */
public class GraphMemUsingHashMap extends GraphMemBase implements GraphWithPerform {
    ...
    private static class IteratorWrapperWithRemove implements ExtendedIterator<Triple> {
        ...
        private final GraphMemUsingHashMap graphMem;
        ...
        public IteratorWrapperWithRemove(Iterator<Triple> iteratorWithNoRemove, GraphMemUsingHashMap graphMem) {
