...
public interface IndexedTripleSource {
    ...
    /**
     * @return the triple stored at the given stable index. Bounds and
     * liveness are not checked; callers must ensure {@code index} is in
     * range and corresponds to a live entry.
     */
    Triple getKeyAt(int index);
}
