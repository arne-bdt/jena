 ...
 */
public class SparseArraySpliteratorMapping<E, T> implements Spliterator<E> {
     ...
     */
    public SparseArraySpliteratorMapping(final T[] entries, final int estimatedElementsCount, final Function<T, E> mapper, final Runnable checkForConcurrentModification) {
