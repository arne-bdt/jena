...
public abstract class ArrayBunch implements TripleBunch
    ...
    @Override
    public boolean isHashed() { return false; }
    ...
    @Override
    public boolean add(Triple t, int hashCode) { throw new UnsupportedOperationException(); }

    @Override
    public void addUnchecked(Triple t, int hashCode) { throw new UnsupportedOperationException(); }
    ...
    */
    ...
    @Override
    public boolean remove(Triple t, int hashCode) { throw new UnsupportedOperationException(); }

    @Override
    public void removeUnchecked(Triple t, int hashCode) { throw new UnsupportedOperationException(); }
