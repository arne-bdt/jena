...
public class IndicesSpliterator implements Spliterator<Integer> {
     ...
     */
    public IndicesSpliterator(final int[] indices, final int fromPos, final int toIndex, final Runnable checkForConcurrentModification) {
     ...
     * @param indices the array
     */
    public IndicesSpliterator(final int[] indices, final Runnable checkForConcurrentModification) {
        this(indices, 0, indices.length, checkForConcurrentModification);
    }
     ...
     * @param indices the array
     */
    public IndicesSpliterator(final int[] indices, final int toIndex, final Runnable checkForConcurrentModification) {
        this(indices, 0, toIndex, checkForConcurrentModification);
    }
    ...
    public Spliterator<Integer> trySplit() {
        ...
        return new IndicesSpliterator(indices, this.pos, toIndexOfSubIterator, checkForConcurrentModification);
    }
