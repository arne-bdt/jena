...
public class TripleListSet_PO extends AdaptiveTripleListSetBase {

    @Override
    protected TripleFilter getMatchFilter(Triple tripleMatch) {
        return new TripleFilter(tripleMatch)
                .filterOnPredicate()
                .filterOnObject();
    }
    ...
    protected QueryableTripleSet createSetForTransition() {
        return new IndexedSet_P_(this.getIndexingNode(), this.size());
    }
