 ...
 */
public class FastTripleHashSetWithIndexingValue2 implements TripleSetWithIndexingValue {
    @Override
    ...
    public FastTripleHashSetWithIndexingValue2(TripleSetWithIndexingValue set) {
