 ...
 */
public class KeyValueFastHashSet2<K, V extends KeyValueFastHashSet2.KeyedValue<K>> implements Set<V> {
    ...
    public boolean add(V value) {
        return add(value, value.getHashCodeOfKey());
    }
    ...
    public void addUnsafe(V value) {
        addUnsafe(value, value.getHashCodeOfKey());
    }
    ...
    public V addIfAbsent(V value) {
        grow();
        var hashCode = value.getHashCodeOfKey();
