...
public interface PointMultimap<T> extends Index {
     ...
     */
    boolean remove(int[] point, T value);
     ...
     * @return the value of the entry or null if the entry was not found
     */
    boolean removeIf(int[] point, Predicate<PointEntry<T>> condition);
     ...
     * @return the value of the entry or null if the entry was not found
     */
    boolean update(int[] oldPoint, int[] newPoint, T value);
     ...
     */
    boolean contains(int[] point, T value);
     ...
     */
    PointIterator<T> queryExactPoint(int[] point);
     ...
     */
    PointIterator<T> query(int[] min, int[] max);
     ...
     */
    default PointEntryKnn<T> query1nn(int[] center) {
     ...
     */
    default PointIteratorKnn<T> queryKnn(int[] center, int k) {
     ...
     * @return list of nearest neighbors
     */
    PointIteratorKnn<T> queryKnn(int[] center, int k, PointDistance distFn);
