...
import org.apache.jena.mem2.specialized.TripleSetWithIndexingNodeSG;
...
class ListsOfTriplesIteratorSG implements ExtendedIterator<Triple> {
    private static final Iterator<TripleSetWithIndexingNodeSG> EMPTY_SET_ITERATOR = Collections.emptyIterator();
    private static final Iterator<Triple> EMPTY_TRIPLES_ITERATOR = Collections.emptyIterator();

    private Iterator<TripleSetWithIndexingNodeSG> baseIterator;
    private Iterator<Triple> subIterator;
    private Triple current;

    public ListsOfTriplesIteratorSG(Iterator<TripleSetWithIndexingNodeSG> baseIterator) {
