 ...
 */
/*
 * This class is a copy from https://github.com/phishman3579/java-algorithms-implementation/blob/master/src/com/jwetherell/algorithms/data_structures/KdTree.java. (date: 04.02.2024)
 * The project source is licenced under https://github.com/phishman3579/java-algorithms-implementation?tab=Apache-2.0-1-ov-file#readme (date: 04.02.2024)
 * Unfortunately, there is no maven repository for this project, so I had to copy the source code.
 * Since I had to copy the source code, I decided to make some changes to the original source code.
 */
 ...
 *
 * Modifications of the oringal code in apache jena:
 * - points had double coordinates x, y, z
 *   --> since we work with the hashCodes of the nodes, we can use integers for the coordinates
 *
 */
