 ...
 */
public class IntIntSetBase implements Set<Integer> {
     ...
     * @return
     */
    private static int[] createEntryArray(final int length){
        return new int[length];
    }

    public IntIntSetBase() {
    ...
    public boolean contains(final int e, final int hashCode) {
        var index = calcStartIndexByHashCode(hashCode);
        if(!used[index]) {
            return false;
        }
        if(hashCode == hashCodes[index] && e == entries[index]) {
            return true;
        } else if(--index < 0){
    ...
    public boolean add(final int value, final int hashCode) {
        grow();
    ...
    public void addWithoutChecking(final int value, final int hashCode) {
        grow();
    ...
    public Integer getIfPresent(final int value, final int hashCode) {
        var index = calcStartIndexByHashCode(hashCode);
        while(true) {
            if(!used[index]) {
                return null;
            } else if(hashCode == hashCodes[index] && value == entries[index]) {
                return entries[index];
            } else if(--index < 0){
                index += entries.length;
            }
    ...
    public Integer compute(final int value, final int hashCode, final Function<Integer, Integer> remappingFunction) {
        var index = findIndex(value, hashCode);
    ...
    public void modifyOrCreateEntry(final int hashCode, final Function<Integer, Integer> remappingFunction) {
        ...
        if(index < 0) { /*value does not exist yet*/
            ...
            remappingFunction.apply(entries[index]);
        }
    }

    public void modifyOrRemoveEntry(final int hashCode, final Function<Integer, Integer> remappingFunction) {
        var index = findIndex(hashCode);
        if(index < 0) { /*value does not exist yet*/
            remappingFunction.apply(null);
        } else { /*existing value found*/
            var newValue = remappingFunction.apply(entries[index]);
            if(newValue == null) {
                used[index] = false;
    ...
    private int findIndex(final int e, final int hashCode) {
        var index = calcStartIndexByHashCode(hashCode);
        while(true) {
            if(!used[index]) {
                return ~index;
            } else if(hashCode == hashCodes[index] && e == entries[index]) {
                return index;
            } else if(--index < 0){
                index += entries.length;
            }
    ...
    public Iterator<Integer> findAllWithSameHashCode(final int hashCode) {
        var index = calcStartIndexByHashCode(hashCode);
        return new ElemmentsWithsSameHashCodeIterator(entries, used, hashCodes, index, hashCode);
    }
    ...
    public boolean remove(int e, int hashCode) {
    ...
    public void removeWithoutChecking(int e, int hashCode) {
        var index = findIndex(e, hashCode);
        used[index] = false;
        size--;
        rearrangeNeighbours(index);
    ...
    public Stream<Integer> streamAllWithSameHashCode(final int hashCode) {
        var index = calcStartIndexByHashCode(hashCode);
        return StreamSupport.stream(Spliterators.spliteratorUnknownSize(new ElemmentsWithsSameHashCodeIterator(entries, used, hashCodes, index, hashCode), 0), false);
    }
    ...
    private static class ArrayWithNullsSpliteratorSized implements Spliterator<Integer> {
        ...
        public ArrayWithNullsSpliteratorSized(final int[] entries, final boolean[] used, final int size) {
    ...
    private static class ArrayWithNullsSubSpliteratorUnSized implements Spliterator<Integer> {
        ...
        public ArrayWithNullsSubSpliteratorUnSized(final int[] entries, final boolean[] used, final int fromIndex, final int toIndex, final int maxSize) {
            this.entries = entries;
            this.used = used;
    ...
    private static class ArrayWithNullsIterator implements Iterator<Integer> {
        ...
        private ArrayWithNullsIterator(final int[] entries, final boolean[] used, final int size) {
            this.entries = entries;
            this.used = used;
            this.remaining = size;
        }
    ...
    private static class ElemmentsWithsSameHashCodeIterator implements Iterator<Integer> {
        ...
        private ElemmentsWithsSameHashCodeIterator(final int[] entries, final boolean[] used, final int[] hashCodes, final int index, final int hashCode) {
            this.entries = entries;
            this.used = used;
        ...
        @Override
        public boolean hasNext() {
            return pos < hashCodes.length && used[pos] && hashCode == hashCodes[pos];
        }
