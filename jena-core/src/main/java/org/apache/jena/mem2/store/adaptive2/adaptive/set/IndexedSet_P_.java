...
import org.apache.jena.mem2.store.adaptive2.adaptive.base.IndexedMapOfIndexedSetsBase;

public class IndexedSet_P_ extends IndexedMapOfIndexedSetsBase {

    public IndexedSet_P_(final Node indexingNode, final int minCapacity) {
        super(indexingNode, minCapacity);
    }

    @Override
    protected QueryableTripleSet createEntry() {
        return new TripleListSet__O();
    }
