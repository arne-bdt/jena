...
/**
 * A mapping spliterator for sparse arrays. This spliterator will iterate over the array
 ...
 * @param <T>
 */
public class SparseArraySubMappingSpliterator<T, U> implements Spliterator<U> {
     ...
     */
    public SparseArraySubMappingSpliterator(final T[] entries, final int fromIndex, final int toIndex, final Function<T, U> mapper, final Runnable checkForConcurrentModification) {
     ...
     * @param entries the array
     */
    public SparseArraySubMappingSpliterator(final T[] entries, Function<T, U> mapper, final Runnable checkForConcurrentModification) {
        this(entries, 0, entries.length, mapper, checkForConcurrentModification);
    }
    ...
    public Spliterator<U> trySplit() {
        ...
        return new SparseArraySubMappingSpliterator<>(entries, this.pos, toIndexOfSubIterator, mapper, checkForConcurrentModification);
    }
