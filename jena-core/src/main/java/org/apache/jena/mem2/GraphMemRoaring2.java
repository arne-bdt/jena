...
import org.apache.jena.mem2.store.roaring2.RoaringTripleStore;
 ...
 * </ul>
 */
public class GraphMemRoaring2 extends GraphMem {
     ...
     */
    public GraphMemRoaring2(IndexingStrategy indexingStrategy) {
        super(new RoaringTripleStore(indexingStrategy));
    }

    private GraphMemRoaring2(final TripleStore tripleStore) {
        super(tripleStore);
    }

    @Override
    public GraphMemRoaring2 copy() {
        return new GraphMemRoaring2(this.tripleStore.copy());
    }
