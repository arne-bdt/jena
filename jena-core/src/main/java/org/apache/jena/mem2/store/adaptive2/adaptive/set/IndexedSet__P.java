...
import org.apache.jena.mem2.store.adaptive2.adaptive.base.MapOfIndexedTriplesBase;

public class IndexedSet__P extends MapOfIndexedTriplesBase {

    public IndexedSet__P(final Node indexingNode, final int minCapacity) {
        super(indexingNode, minCapacity);
    }

    @Override
    protected TripleFilter getMatchFilter(Triple tripleMatch) {
        return new TripleFilter(tripleMatch).filterOnPredicate();
    }
}
