 ...
 * has been fixed.
 */
public class GraphMem5 extends GraphMemBase implements GraphWithPerform {
    ...
    private static class TripleListSetForSubjects extends TripleListSetWithIndexingValueBase {

        public TripleListSetForSubjects() {
    ...
    private static class TripleListSetForPredicates extends TripleListSetWithIndexingValueBase {

        public TripleListSetForPredicates() {
            super(INITIAL_SIZE_FOR_ARRAY_LISTS);
        }
    ...
    private static class TripleListSetForObjects extends TripleListSetWithIndexingValueBase {

        public TripleListSetForObjects() {
            super(INITIAL_SIZE_FOR_ARRAY_LISTS);
        }
