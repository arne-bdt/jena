...
public abstract class FastHashSetBase<E> implements Set<E> {
    ...
    public boolean add(final E value, final int hashCode) {
        grow();
    ...
    public void addWithoutChecking(final E value, final int hashCode) {
        grow();
    ...
    public E getIfPresent(final E value, final int hashCode) {
        var index = calcStartIndexByHashCode(hashCode);
        while(true) {
            if(null == entries[index]) {
                return null;
    ...
    public E getIfPresent(final int hashCode) {
        var index = calcStartIndexByHashCode(hashCode);
        while(true) {
            if(null == entries[index]) {
                return null;
    ...
    public E compute(final E value, final int hashCode, final Function<E, E> remappingFunction) {
        var index = findIndex(value, hashCode);
    ...
    public void modifyOrCreateEntry(final int hashCode, final Function<E, E> remappingFunction) {
    ...
    public void modifyOrRemoveEntry(final int hashCode, final Function<E, E> remappingFunction) {
        var index = findIndex(hashCode);
        if(index < 0) { /*value does not exist yet*/
    ...
    private Iterator<E> findAllWithSameHashCode(final int hashCode) {
        var index = calcStartIndexByHashCode(hashCode);
        return new ElemmentsWithsSameHashCodeIterator(entries, hashCodes, index, hashCode);
    }
    ...
    public void removeWithoutChecking(E e, int hashCode) {
        var index = findIndex(e, hashCode);
        entries[index] = null;
        size--;
        rearrangeNeighbours(index);
    ...
    private static class ArrayWithNullsIterator<E> implements Iterator<E> {
        ...
        private ArrayWithNullsIterator(final E[] entries, final int size) {
            this.entries = entries;
            this.remaining = size;
        }
    ...
    private static class ElemmentsWithsSameHashCodeIterator<E> implements Iterator<E> {
        ...
        private ElemmentsWithsSameHashCodeIterator(final E[] entries, final int[] hashCodes, final int index, final int hashCode) {
            this.entries = entries;
        ...
        @Override
        public boolean hasNext() {
            return pos < hashCodes.length && hashCode == hashCodes[pos] && null != entries[pos];
        }
