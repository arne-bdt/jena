 ...
 */
public class FastTripleHashSetWithIndexingValueB implements TripleSetWithIndexingValue {
    @Override
    ...
    private transient Triple[] entries;
    private transient int[] hashCodes;
    private transient boolean[] used;

    private transient Object indexingValue;
    ...
    public FastTripleHashSetWithIndexingValueB(TripleSetWithIndexingValue set) {
    ...
    private static class ArrayWithNullsSpliteratorSized implements Spliterator<Triple> {
        ...
        public ArrayWithNullsSpliteratorSized(final Triple[] entries, boolean[] used, final int size) {
    ...
    private static class ArrayWithNullsSubSpliteratorUnSized implements Spliterator<Triple> {
        ...
        public ArrayWithNullsSubSpliteratorUnSized(final Triple[] entries, boolean[] used, final int fromIndex, final int toIndex, final int maxSize) {
            this.entries = entries;
            this.used = used;
    ...
    private static class ArrayWithNullsIterator implements Iterator<Triple> {
        ...
        private ArrayWithNullsIterator(final Triple[] entries, boolean[] used, final int size) {
            this.entries = entries;
            this.used = used;
            this.remaining = size;
        }
