...
public class ArrayWithNullsSubSpliterator1<E> implements Spliterator<E> {
     ...
     */
    public ArrayWithNullsSubSpliterator1(final E[] entries, final int fromIndex, final int toIndex, final int estimatedElementsCount) {
    ...
    public Spliterator<E> trySplit() {
        ...
        return new ArrayWithNullsSubSpliterator1(entries, this.pos, toIndexOfSubIterator, estimatedElementsCount);
    }
