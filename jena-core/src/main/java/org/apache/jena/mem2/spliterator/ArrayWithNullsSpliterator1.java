...
public class ArrayWithNullsSpliterator1<E> implements Spliterator<E> {

    private final E[] entries;
    private int pos;
    private int estimatedElementsCount;

    public ArrayWithNullsSpliterator1(final E[] entries, final int size) {
        this.entries = entries;
        this.pos = entries.length-1;
        this.estimatedElementsCount = size;
    }
    ...
    public Spliterator<E> trySplit() {
        ...
        final var toIndex = this.pos+1;
        this.pos = (this.pos >>> 1);
        this.estimatedElementsCount = remaining >>> 1;
        return new ArrayWithNullsSubSpliterator1(entries, this.pos, toIndex, estimatedElementsCount);
    }
    ...
    public long estimateSize() {
        return (int) ((double) estimatedElementsCount / entries.length  * pos);
    }
