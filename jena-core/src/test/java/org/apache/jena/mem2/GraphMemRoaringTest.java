...
public class GraphMemRoaringTest extends AbstractGraphMemTest {
    ...
    protected GraphMem createGraph() {
        switch (indexingStrategy) {
            case EAGER, LAZY, LAZY_PARALLEL, MINIMAL:
                return new org.apache.jena.mem2.GraphMemRoaring(indexingStrategy);
            case MANUAL:
    ...
    private org.apache.jena.mem2.GraphMemRoaring setupGraphWithSpyForSpecialManualStrategy() {
        final var realGraph = new org.apache.jena.mem2.GraphMemRoaring(IndexingStrategy.MANUAL);
    ...
    private org.apache.jena.mem2.GraphMemRoaring getSutAsGraphMem2Roaring() {
