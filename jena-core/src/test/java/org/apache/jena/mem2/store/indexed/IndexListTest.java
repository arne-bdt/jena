...
public class IndexListTest {
    ...
    @Test
    public void cloneEqualsCopyConstructor() {
        final var src = new IndexList();
        src.add(11);
        src.add(22);
        src.add(33);

        final var clone = src.clone();
    ...
    public void intersectsReturnsTrueForCommonElement() {
        ...
        java.util.Arrays.fill(reverseA, Integer.MAX_VALUE);
        java.util.Arrays.fill(reverseB, Integer.MAX_VALUE);
