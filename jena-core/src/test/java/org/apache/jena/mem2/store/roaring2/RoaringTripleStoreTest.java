...
public class RoaringTripleStoreTest extends AbstractTripleStoreTest {
    ...
    protected TripleStore createTripleStore() {
        switch (indexingStrategy) {
            case EAGER, LAZY, LAZY_PARALLEL, MINIMAL:
                return new org.apache.jena.mem2.store.roaring2.RoaringTripleStore(indexingStrategy);
            case MANUAL:
    ...
    private org.apache.jena.mem2.store.roaring2.RoaringTripleStore setupStoreWithSpyForSpecialManualStrategy() {
        final var realStore = new org.apache.jena.mem2.store.roaring2.RoaringTripleStore(IndexingStrategy.MANUAL);
    ...
    private org.apache.jena.mem2.store.roaring2.RoaringTripleStore getSutAsRoaringTripleStore() {
        return (org.apache.jena.mem2.store.roaring2.RoaringTripleStore) super.sut;
    }
