...
public class RoaringBitmapTripleIteratorTest {
    ...
    public void testEmpty() {
        ...
        final var sut = new org.apache.jena.mem2.store.roaring.RoaringBitmapTripleIterator(bitmap, set);
    ...
    public void testMoreThanInBuffer() {
        final var bitmap = new RoaringBitmap();
        final var set = createTripleSet();
        for (int i = 0; i < org.apache.jena.mem2.store.roaring.RoaringBitmapTripleIterator.BUFFER_SIZE + 1; i++) {
