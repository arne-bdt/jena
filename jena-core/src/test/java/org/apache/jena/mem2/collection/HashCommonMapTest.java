...
public class HashCommonMapTest extends AbstractJenaMapNodeTest {
    ...
    private static class HashCommonNodeObjectMap extends org.apache.jena.mem2.collection.HashCommonMap<Node, Object> {
        protected HashCommonNodeObjectMap(int initialCapacity) {
            super(initialCapacity);
        }

        protected HashCommonNodeObjectMap(org.apache.jena.mem2.collection.HashCommonMap<Node, Object> mapToCopy) {
            super(mapToCopy);
        }
