...
public class IndexListsSpliteratorTest {
    ...
    public void setUp() {
        ...
        reverseA = new int[64];
        reverseB = new int[64];
        Arrays.fill(reverseA, Integer.MAX_VALUE);
        Arrays.fill(reverseB, Integer.MAX_VALUE);
    ...
    public void trySplitReturnsNullWhenSmallerListCannotBeSplit() {
        ...
        Arrays.fill(revA, Integer.MAX_VALUE);
        Arrays.fill(revB, Integer.MAX_VALUE);
    ...
    @Test
    public void characteristicsAdvertiseDistinctNonNullImmutableButNotSized() {
        final var sp = new IndexListsSpliterator(triples, listA, reverseA, listB, reverseB);
        final int chars = sp.characteristics();
        assertTrue((chars & Spliterator.DISTINCT) != 0);
        assertTrue((chars & Spliterator.NONNULL) != 0);
        assertTrue((chars & Spliterator.IMMUTABLE) != 0);
