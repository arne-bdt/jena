...
public class HashedTripleBunchTest extends AbstractJenaSetTripleTest {
    ...
    protected JenaSet<Triple> createTripleSet() {
        return new org.apache.jena.mem2.store.legacy.HashedTripleBunch();
    }

    @Test
    public void testConstructorWithArrayBunchEmpty() {
        final var arrayBunch = new org.apache.jena.mem2.store.legacy.ArrayBunch();
        final var sut = new org.apache.jena.mem2.store.legacy.HashedTripleBunch(arrayBunch);
