...
public class SparseArrayIndexedIteratorTest {
    ...
    public void testHasNextAndNextWithNonNullEntries() {
        ...
        iterator = new SparseArrayIndexedIterator<>(entries, deleted, () -> {});
    ...
    public void testConstrucorWithToIndexConstraint3() {
        String[] entries = new String[]{"first", "second", "third"};
        final var deleted = new boolean[] { false, false, false };
        iterator = new SparseArrayIndexedIterator<>(entries, deleted, 3, () -> {});
    ...
    public void testConstrucorWithToIndexConstraint2() {
        String[] entries = new String[]{"first", "second", "third"};
        final var deleted = new boolean[] { false, false, false };
        iterator = new SparseArrayIndexedIterator<>(entries, deleted, 2, () -> {});
    ...
    public void testConstrucorWithToIndexConstraint1() {
        String[] entries = new String[]{"first", "second", "third"};
        final var deleted = new boolean[] { false, false, false };
        iterator = new SparseArrayIndexedIterator<>(entries, deleted, 1, () -> {});
    ...
    public void testConstrucorWithToIndexConstraint0() {
        String[] entries = new String[]{"first", "second", "third"};
        final var deleted = new boolean[] { false, false, false };
        iterator = new SparseArrayIndexedIterator<>(entries, deleted, 0, () -> {});
    ...
    public void testHasNextAndNextWithNullEntries() {
        ...
        final var deleted = new boolean[] { false, true, false, true, false };
        iterator = new SparseArrayIndexedIterator<>(entries, deleted, () -> {});
