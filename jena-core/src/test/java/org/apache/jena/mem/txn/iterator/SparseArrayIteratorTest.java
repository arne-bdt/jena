...
public class SparseArrayIteratorTest {
    ...
    private org.apache.jena.mem.iterator.SparseArrayIterator<String> iterator;

    @Test
    public void testHasNextAndNextWithNonNullEntries() {
        String[] entries = new String[]{"first", "second", "third"};
        iterator = new org.apache.jena.mem.iterator.SparseArrayIterator<>(entries, () -> {
        });
    ...
    public void testConstrucorWithToIndexConstraint3() {
        String[] entries = new String[]{"first", "second", "third"};
        iterator = new org.apache.jena.mem.iterator.SparseArrayIterator<>(entries, 3, () -> {
        });
    ...
    public void testConstrucorWithToIndexConstraint2() {
        String[] entries = new String[]{"first", "second", "third"};
        iterator = new org.apache.jena.mem.iterator.SparseArrayIterator<>(entries, 2, () -> {
        });
    ...
    public void testConstrucorWithToIndexConstraint1() {
        String[] entries = new String[]{"first", "second", "third"};
        iterator = new org.apache.jena.mem.iterator.SparseArrayIterator<>(entries, 1, () -> {
        });
    ...
    public void testConstrucorWithToIndexConstraint0() {
        String[] entries = new String[]{"first", "second", "third"};
        iterator = new org.apache.jena.mem.iterator.SparseArrayIterator<>(entries, 0, () -> {
        });
