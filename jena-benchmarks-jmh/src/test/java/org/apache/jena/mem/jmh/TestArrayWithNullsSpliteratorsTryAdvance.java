...
public class TestArrayWithNullsSpliteratorsTryAdvance {
    ...
    @Param({
//            "ArrayWithNullsSpliteratorSized",
//            "ArrayWithNullsSubSpliteratorUnSized",
//            "ArrayWithNullsSpliterator",
//            "ArrayWithNullsSubSpliterator",
//            "ArrayWithNullsSpliterator1",
//            "ArrayWithNullsSubSpliterator1",
    ...
    public Spliterator<Object> createSut(Object[] arrayWithNulls, int elementsCount) {
        ...
        switch (param1_iteratorImplementation) {
            case "ArrayWithNullsSpliteratorSized":
                return new ArrayWithNullsSpliteratorSized<>(arrayWithNulls, elementsCount);

            case "ArrayWithNullsSubSpliteratorUnSized":
                return new ArrayWithNullsSubSpliteratorUnSized<>(arrayWithNulls, 0, arrayWithNulls.length, elementsCount);

            case "ArrayWithNullsSpliterator":
                return new ArrayWithNullsSpliterator<>(arrayWithNulls, elementsCount);

            case "ArrayWithNullsSubSpliterator":
                return new ArrayWithNullsSubSpliterator<>(arrayWithNulls, 0, arrayWithNulls.length, elementsCount);

            case "ArrayWithNullsSpliterator1":
                return new ArrayWithNullsSpliterator1<>(arrayWithNulls, elementsCount);

            case "ArrayWithNullsSubSpliterator1":
                return new ArrayWithNullsSubSpliterator1<>(arrayWithNulls, 0, arrayWithNulls.length, elementsCount);

            case "SparseArraySpliterator":
                return new org.apache.jena.mem.SparseArraySpliterator<>(arrayWithNulls, 0, checkForConcurrentModification);

            case "SparseArraySubSpliterator":
                return new org.apache.jena.mem.SparseArraySubSpliterator<>(arrayWithNulls, 0, checkForConcurrentModification);
