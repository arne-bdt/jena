...
public final class TxnGraphContext {
    ...
    /** Phase A: deep-copy on begin(WRITE). */
    public static final String GMIS_TXN_EAGER       = "GraphMemIndexedSetTxn EAGER (Phase A)";
    public static final String GMIS_TXN_LAZY        = "GraphMemIndexedSetTxn LAZY (Phase A)";

    /** Phase B: copy-on-write fork at begin(WRITE). */
    public static final String GMIS_COW_TXN_EAGER_SEQ      = "GraphMemIndexedSetCowTxn EAGER SEQ (Phase B)";
    public static final String GMIS_COW_TXN_EAGER_PARALLEL = "GraphMemIndexedSetCowTxn EAGER PARALLEL (Phase B)";
    public static final String GMIS_COW_TXN_LAZY           = "GraphMemIndexedSetCowTxn LAZY (Phase B)";
    public static final String GMIS_COW_TXN_LAZY_PARALLEL  = "GraphMemIndexedSetCowTxn LAZY_PARALLEL (Phase B)";
    ...
    /** True iff the given variant requires explicit begin/commit/end. */
    public static boolean isTransactional(String variant) {
        return !variant.startsWith("GraphMemIndexedSet ");
    }
