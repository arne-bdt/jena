...
public class TestCoalesce {
    ...
    public Long benchmarkCoalesceJenaCurrent() {
        ...
        var var3BoundLiteral =  NodeFactory.createLiteralString("Value3");
        var bindingBuilder = Binding.builder();
        bindingBuilder.add(expressions.get(2).asVar(), var3BoundLiteral);
    ...
    public Long benchmarkCoalesceJena550() {
        ...
        var var3BoundLiteral =  org.apache.shadedJena550.graph.NodeFactory.createLiteralString("Value3");
    ...
    @Ignore
    @Test
    public void profileCoalesceJenaCurrent() {
        var checksum = 0L;
        // Create a Coalesce expression with some dummy expressions
        var expressions = new ExprList();
        expressions.add(new ExprVar("var1"));
        ...
        for(var i=0; i<100000; i++) {
            // Evaluate the expression with a dummy binding and function environment
            var result = coalesceExpr.eval(binding, env);
            if( result != null ) {
                checksum += i;
            }
    ...
    @Ignore
    @Test
    public void profileCoalesceJena550() {
        var checksum = 0L;
        // Create a Coalesce expression with some dummy expressions
        var expressions = new org.apache.shadedJena550.sparql.expr.ExprList();
        expressions.add(new org.apache.shadedJena550.sparql.expr.ExprVar("var1"));
    ...
    @Ignore
    @Test
    public void profileCoalesceJenaCurrentAnd550() {
