 ...
 * inside read transactions. The two transactional graphs (deep-copy,
 * copy-on-write) should diverge most starkly here, because deep copy
 * on every begin(WRITE) blocks readers from progressing while
 * copy-on-write fork is allocation-light.
 * <p>
