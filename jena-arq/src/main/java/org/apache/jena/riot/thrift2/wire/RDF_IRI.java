...
public class RDF_IRI implements org.apache.thrift.TBase<RDF_IRI, RDF_IRI._Fields>, java.io.Serializable, Cloneable, Comparable<RDF_IRI> {
  ...
  public @org.apache.thrift.annotation.Nullable String iri; // required
  ...
  public RDF_IRI setIri(@org.apache.thrift.annotation.Nullable String iri) {
    this.iri = iri;
    return this;
  }
  ...
  public int compareTo(RDF_IRI other) {
    ...
    lastComparison = Boolean.compare(isSetIri(), other.isSetIri());
    if (lastComparison != 0) {
