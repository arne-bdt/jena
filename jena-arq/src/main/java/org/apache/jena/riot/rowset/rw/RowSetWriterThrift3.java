...
public class RowSetWriterThrift3 implements RowSetWriter {

    public static RowSetWriterFactory factory = lang -> {
        if (!Objects.equals(lang, ResultSetLang.RS_Thrift3) )
            throw new ResultSetException("RowSetWriterThrift3 for RDF/Thrift3 asked for a "+lang);
        return new RowSetWriterThrift3();
    };

    @Override
    public void write(OutputStream out, RowSet rowSet, Context context)
    { Thrift3RDF.writeRowSet(out, rowSet) ; }
