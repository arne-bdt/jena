...
public class RDF_PrefixName implements org.apache.thrift.TBase<RDF_PrefixName, RDF_PrefixName._Fields>, java.io.Serializable, Cloneable, Comparable<RDF_PrefixName> {
  ...
  public @org.apache.thrift.annotation.Nullable String localName; // required
  ...
  public RDF_PrefixName setPrefix(@org.apache.thrift.annotation.Nullable String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public RDF_PrefixName setLocalName(@org.apache.thrift.annotation.Nullable String localName) {
    this.localName = localName;
    return this;
  }
  ...
  public int compareTo(RDF_PrefixName other) {
    ...
    lastComparison = Boolean.compare(isSetLocalName(), other.isSetLocalName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLocalName()) {
