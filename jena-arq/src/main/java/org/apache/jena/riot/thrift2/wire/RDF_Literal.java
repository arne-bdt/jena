...
public class RDF_Literal implements org.apache.thrift.TBase<RDF_Literal, RDF_Literal._Fields>, java.io.Serializable, Cloneable, Comparable<RDF_Literal> {
  ...
  public @org.apache.thrift.annotation.Nullable String lex; // required
  public @org.apache.thrift.annotation.Nullable String langtag; // optional
  public @org.apache.thrift.annotation.Nullable String datatype; // optional
  ...
  public RDF_Literal setLex(@org.apache.thrift.annotation.Nullable String lex) {
    this.lex = lex;
    return this;
  }
  ...
  public RDF_Literal setLangtag(@org.apache.thrift.annotation.Nullable String langtag) {
  ...
  public RDF_Literal setDatatype(@org.apache.thrift.annotation.Nullable String datatype) {
  ...
  public int compareTo(RDF_Literal other) {
    ...
    lastComparison = Boolean.compare(isSetLex(), other.isSetLex());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSetLangtag(), other.isSetLangtag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLangtag()) {
    ...
    lastComparison = Boolean.compare(isSetDatatype(), other.isSetDatatype());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDatatype()) {
    ...
    lastComparison = Boolean.compare(isSetDtPrefix(), other.isSetDtPrefix());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDtPrefix()) {
