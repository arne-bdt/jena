...
public class RDF_Patch_Union extends org.apache.thrift.TUnion<RDF_Patch_Union, RDF_Patch_Union._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RDF_Patch_Union");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RDF_Patch_Union.class, metaDataMap);
  }

  public RDF_Patch_Union() {
    super();
  }

  public RDF_Patch_Union(_Fields setField, java.lang.Object value) {
    super(setField, value);
  }

  public RDF_Patch_Union(RDF_Patch_Union other) {
    super(other);
  }
  @Override
  public RDF_Patch_Union deepCopy() {
    return new RDF_Patch_Union(this);
  }

  public static RDF_Patch_Union header(Patch_Header value) {
    RDF_Patch_Union x = new RDF_Patch_Union();
    x.setHeader(value);
    return x;
  }

  public static RDF_Patch_Union dataAdd(Patch_Data_Add value) {
    RDF_Patch_Union x = new RDF_Patch_Union();
    x.setDataAdd(value);
    return x;
  }

  public static RDF_Patch_Union dataDel(Patch_Data_Del value) {
    RDF_Patch_Union x = new RDF_Patch_Union();
    x.setDataDel(value);
    return x;
  }

  public static RDF_Patch_Union prefixAdd(Patch_Prefix_Add value) {
    RDF_Patch_Union x = new RDF_Patch_Union();
    x.setPrefixAdd(value);
    return x;
  }

  public static RDF_Patch_Union prefixDel(Patch_Prefix_Del value) {
    RDF_Patch_Union x = new RDF_Patch_Union();
    x.setPrefixDel(value);
    return x;
  }

  public static RDF_Patch_Union txn(PatchTxn value) {
    RDF_Patch_Union x = new RDF_Patch_Union();
    x.setTxn(value);
    return x;
  }
      ...
      switch (setField) {
        ...
        case TXN:
          if (field.type == TXN_FIELD_DESC.type) {
            PatchTxn txn;
            txn = org.apache.jena.riot.thrift3.wire.PatchTxn.findByValue(iprot.readI32());
            return txn;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
  ...
  public boolean equals(java.lang.Object other) {
    if (other instanceof RDF_Patch_Union) {
      return equals((RDF_Patch_Union)other);
    } else {
      return false;
    }
  }

  public boolean equals(RDF_Patch_Union other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(RDF_Patch_Union other) {
