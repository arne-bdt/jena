...
class ParserRRX_StAX2_SR {
    ...
    ParserRRX_StAX2_SR(XMLStreamReader reader, String xmlBase, ParserProfile parserProfile, StreamRDF destination, Context context) {
        // Debug
        ...
        out.setLinePrefix("# ");
        this.trace = out;
        EVENTS = ReaderRDFXML_StAX2_SR.TRACE;
        // Debug
    ...
    void parse() {
        ...
        if ( qNameMatches(rdfRDF, qName()) ) {
            if ( ReaderRDFXML_StAX2_SR.TRACE )
