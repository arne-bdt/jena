 ...
 */
public class ReaderRDFXML_StAX_SR_woodstox implements ReaderRIOT
{
    ...
    public static ReaderRIOTFactory factory = (Lang language, ParserProfile parserProfile) -> {
        ...
        return new ReaderRDFXML_StAX_SR_woodstox(parserProfile);
    };
    ...
    public ReaderRDFXML_StAX_SR_woodstox(ParserProfile parserProfile) {
