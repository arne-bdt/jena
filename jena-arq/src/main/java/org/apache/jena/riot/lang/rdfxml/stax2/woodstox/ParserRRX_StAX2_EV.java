...
class ParserRRX_StAX2_EV {
    ...
    ParserRRX_StAX2_EV(XMLEventReader reader, String xmlBase, ParserProfile parserProfile, StreamRDF destination, Context context) {
        // Debug
        ...
        out.setLinePrefix("# ");
        this.trace = out;
        EVENTS = ReaderRDFXML_StAX2_EV.TRACE;
        // Debug
...
//                   rdfDescription, rdfContainerItem);
    ...
    void parse() {
        ...
        if ( event.isStartDocument() ) {
            if ( ReaderRDFXML_StAX2_EV.TRACE )
