...
public class RDF_StreamUnion extends org.apache.thrift.TUnion<RDF_StreamUnion, RDF_StreamUnion._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RDF_StreamUnion");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RDF_StreamUnion.class, metaDataMap);
  }

  public RDF_StreamUnion() {
    super();
  }

  public RDF_StreamUnion(_Fields setField, java.lang.Object value) {
    super(setField, value);
  }

  public RDF_StreamUnion(RDF_StreamUnion other) {
    super(other);
  }
  @Override
  public RDF_StreamUnion deepCopy() {
    return new RDF_StreamUnion(this);
  }

  public static RDF_StreamUnion prefixDecl(RDF_PrefixDecl value) {
    RDF_StreamUnion x = new RDF_StreamUnion();
    x.setPrefixDecl(value);
    return x;
  }

  public static RDF_StreamUnion triple(RDF_Triple value) {
    RDF_StreamUnion x = new RDF_StreamUnion();
    x.setTriple(value);
    return x;
  }

  public static RDF_StreamUnion quad(RDF_Quad value) {
    RDF_StreamUnion x = new RDF_StreamUnion();
    x.setQuad(value);
    return x;
  }
  ...
  public boolean equals(java.lang.Object other) {
    if (other instanceof RDF_StreamUnion) {
      return equals((RDF_StreamUnion)other);
    } else {
      return false;
    }
  }

  public boolean equals(RDF_StreamUnion other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(RDF_StreamUnion other) {
