 ...
 */
public class ReaderRDFXML_StAX2_SR implements ReaderRIOT
{
    ...
    public static ReaderRIOTFactory factory = (Lang language, ParserProfile parserProfile) -> {
        ...
        return new ReaderRDFXML_StAX2_SR(parserProfile);
    };
    ...
    public ReaderRDFXML_StAX2_SR(ParserProfile parserProfile) {
    ...
    public void read(Reader reader, String baseURI, ContentType ct, StreamRDF output, Context context) {
     ...
     private void parse(XMLStreamReader xmlStreamReader, String xmlBase, ContentType ct, StreamRDF destination, Context context) {
        ParserRRX_StAX2_SR parser = new ParserRRX_StAX2_SR(xmlStreamReader, xmlBase, parserProfile, destination, context);
        destination.start();
        try {
            parser.parse();
