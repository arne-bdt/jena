...
public class Patch_Prefix_Add implements org.apache.thrift.TBase<Patch_Prefix_Add, Patch_Prefix_Add._Fields>, java.io.Serializable, Cloneable, Comparable<Patch_Prefix_Add> {
  ...
  public @org.apache.thrift.annotation.Nullable String prefix; // required
  public @org.apache.thrift.annotation.Nullable String iriStr; // required
  ...
  public Patch_Prefix_Add setPrefix(@org.apache.thrift.annotation.Nullable String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public Patch_Prefix_Add setIriStr(@org.apache.thrift.annotation.Nullable String iriStr) {
    this.iriStr = iriStr;
    return this;
  }
  ...
  public int compareTo(Patch_Prefix_Add other) {
    ...
    lastComparison = Boolean.compare(isSetGraphNode(), other.isSetGraphNode());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSetPrefix(), other.isSetPrefix());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrefix()) {
    ...
    lastComparison = Boolean.compare(isSetIriStr(), other.isSetIriStr());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIriStr()) {
