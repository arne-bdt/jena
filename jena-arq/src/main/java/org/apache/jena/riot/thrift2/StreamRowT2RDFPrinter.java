...
public class StreamRowT2RDFPrinter implements VisitorStreamRowT2RDF
{
    ...
    public StreamRowT2RDFPrinter(IndentedWriter out, StringDictionaryReader readerDict) { this.out = out ;
