...
public class Patch_Prefix_Add implements org.apache.thrift.TBase<Patch_Prefix_Add, Patch_Prefix_Add._Fields>, java.io.Serializable, Cloneable, Comparable<Patch_Prefix_Add> {
  ...
  private static final org.apache.thrift.protocol.TField IRI_STR_FIELD_DESC = new org.apache.thrift.protocol.TField("iriStr", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  private static final int __IRISTR_ISSET_ID = 1;
  ...
  public Patch_Prefix_Add setPrefix(int prefix) {
    this.prefix = prefix;
    setPrefixIsSet(true);
    return this;
  }
  ...
  public int getIriStr() {
    return this.iriStr;
  }

  public Patch_Prefix_Add setIriStr(int iriStr) {
    this.iriStr = iriStr;
    setIriStrIsSet(true);
    return this;
  }
  ...
  public void unsetIriStr() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IRISTR_ISSET_ID);
  }

  /** Returns true if field iriStr is set (has been assigned a value) and false otherwise */
  public boolean isSetIriStr() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __IRISTR_ISSET_ID);
  }

  public void setIriStrIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IRISTR_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case IRI_STR:
      if (value == null) {
        ...
        setIriStr((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(Patch_Prefix_Add that) {
    ...
    boolean this_present_iriStr = true;
    boolean that_present_iriStr = true;
    if (this_present_iriStr || that_present_iriStr) {
      if (!(this_present_iriStr && that_present_iriStr))
        return false;
      if (this.iriStr != that.iriStr)
        return false;
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'iriStr' because it's a primitive and you chose the non-beans generator.
  ...
  private static class Patch_Prefix_AddStandardScheme extends org.apache.thrift.scheme.StandardScheme<Patch_Prefix_Add> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Patch_Prefix_Add struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetIriStr()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'iriStr' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
