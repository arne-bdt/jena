  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case TXN:
        ...
        throw new ClassCastException("Was expecting value of type PatchTxn for field 'txn', but got " + value.getClass().getSimpleName());
      default:
      ...
      switch (setField) {
        ...
        case TXN:
          if (field.type == TXN_FIELD_DESC.type) {
            PatchTxn txn;
            txn = PatchTxn.findByValue(iprot.readI32());
            return txn;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
