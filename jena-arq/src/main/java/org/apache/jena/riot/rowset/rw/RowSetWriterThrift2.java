...
public class RowSetWriterThrift2 implements RowSetWriter {

    public static RowSetWriterFactory factory = lang -> {
        if (!Objects.equals(lang, ResultSetLang.RS_Thrift2 ) )
            throw new ResultSetException("RowSetWriter for RDF/Thrift2 asked for a "+lang);
        return new RowSetWriterThrift2();
    };

    @Override
    public void write(OutputStream out, RowSet rowSet, Context context)
    { Thrift2RDF.writeRowSet(out, rowSet) ; }
