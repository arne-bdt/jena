...
public class RDF_Term extends org.apache.thrift.TUnion<RDF_Term, RDF_Term._Fields> {
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case TRIPLE_TERM:
        ...
        throw new ClassCastException("Was expecting value of type RDF_Triple for field 'tripleTerm', but got " + value.getClass().getSimpleName());
      case VAL_INTEGER:
        if (value instanceof Long) {
          break;
        }
        throw new ClassCastException("Was expecting value of type java.lang.Long for field 'valInteger', but got " + value.getClass().getSimpleName());
      case VAL_DOUBLE:
        if (value instanceof Double) {
          break;
        }
        throw new ClassCastException("Was expecting value of type java.lang.Double for field 'valDouble', but got " + value.getClass().getSimpleName());
      case VAL_DECIMAL:
  ...
  public RDF_Triple getTripleTerm() {
    if (getSetField() == _Fields.TRIPLE_TERM) {
      ...
      throw new RuntimeException("Cannot get field 'tripleTerm' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
