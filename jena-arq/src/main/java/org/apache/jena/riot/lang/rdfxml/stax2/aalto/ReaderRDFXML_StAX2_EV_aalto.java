 ...
 */
public class ReaderRDFXML_StAX2_EV_aalto implements ReaderRIOT
{
    ...
    public static ReaderRIOTFactory factory = (Lang language, ParserProfile parserProfile) -> {
        ...
        return new ReaderRDFXML_StAX2_EV_aalto(parserProfile);
    };
    ...
    public ReaderRDFXML_StAX2_EV_aalto(ParserProfile parserProfile) {
    ...
    private void parse(XMLEventReader xmlEventReader, String xmlBase, ContentType ct, StreamRDF destination, Context context) {
        ParserRRX_StAX2_EV_aalto parser = new ParserRRX_StAX2_EV_aalto(xmlEventReader, xmlBase, parserProfile, destination, context);
        destination.start();
        try {
            parser.parse();
