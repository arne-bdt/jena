...
public class T3RDF {
    ...
    public static TProtocol protocol(InputStream in) {
        ...
        try {
            ...
            return protocol ;
        } catch (TException ex) { T3RDF.exception(ex) ; return null ; }
    }

    /**
     * Create Thrift protocol for the OutputStream.
     * The caller must call {@link T3RDF#flush(TProtocol)}
    ...
    public static TProtocol protocol(TTransport transport) {
        ...
        throw new RiotThrift3Exception("No protocol impl choosen") ;
    }
    ...
    public static void visit(RDF_StreamRow row, VisitorStreamRowT3RDF visitor, StringDictionaryReader readerDict) {
        ...
        if ( r.isSetTriple() ) {
            ...
            Log.warn(Thrift3Convert.class, "visit: Unrecognized: "+row) ;
        }
    }

    public static void exception(TException ex) { throw new RiotThrift3Exception(ex) ; }
