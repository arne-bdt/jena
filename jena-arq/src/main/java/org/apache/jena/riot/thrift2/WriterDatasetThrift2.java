...
public class WriterDatasetThrift2 implements WriterDatasetRIOT
{
    @Override
    public Lang getLang() {
        return RDFTHRIFT2 ;
    ...
    public void write(Writer out, DatasetGraph dsg, PrefixMap prefixMap, String baseURI, Context context) {
        throw new RiotThrift2Exception("Writing binary data to a java.io.Writer is not supported. Please use an OutputStream") ;
    }
    @Override
