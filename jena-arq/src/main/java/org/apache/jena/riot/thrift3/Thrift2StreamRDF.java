...
public class Thrift2StreamRDF implements VisitorStreamRowT3RDF {
    ...
    public void visit(RDF_Triple rt) {
        Triple t = Thrift3Convert.convert(uriCache, rt, pmap, readerDict);
        dest.triple(t);
    }

    @Override
    public void visit(RDF_Quad rq) {
        Quad q = Thrift3Convert.convert(uriCache, rq, pmap, readerDict);
        dest.quad(q);
    }
