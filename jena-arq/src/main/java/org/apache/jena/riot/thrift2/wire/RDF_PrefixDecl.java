...
public class RDF_PrefixDecl implements org.apache.thrift.TBase<RDF_PrefixDecl, RDF_PrefixDecl._Fields>, java.io.Serializable, Cloneable, Comparable<RDF_PrefixDecl> {
  ...
  public RDF_PrefixDecl setPrefix(@org.apache.thrift.annotation.Nullable String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public RDF_PrefixDecl setUri(@org.apache.thrift.annotation.Nullable String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public int compareTo(RDF_PrefixDecl other) {
    ...
    lastComparison = Boolean.compare(isSetUri(), other.isSetUri());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUri()) {
