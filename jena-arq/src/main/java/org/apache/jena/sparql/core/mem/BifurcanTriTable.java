...
/**
 * A three-way {@link TripleTable} using all of the available forms in {@link TripleTableForm}, backed by
 * {@link BifurcanTripleTable} indexes. This is the Bifurcan-backed analogue of {@link TriTable}.
 *
 * @see TriTable
 */
public class BifurcanTriTable implements TripleTable {

    private final Map<TripleTableForm, TripleTable> indexBlock = new EnumMap<TripleTableForm, TripleTable>(
        tableForms().collect(toMap(x -> x, form -> new BifurcanTripleTable(form.name()))));
