...
/**
 * A {@link DatasetGraph} that holds a set of named graphs and an empty default graph.
 * <p>
 ...
 */
public class LinkedDatasetGraph extends DatasetGraphCollection {

    public class LinkedDatasetTransactionException extends RuntimeException {
