...
/** Promote tests for {@link DatasetGraphInMemoryCowTxn}. */
public class TestDatasetGraphInMemoryCowTxnPromote extends AbstractTestTransPromote {
    public TestDatasetGraphInMemoryCowTxnPromote() {
        super(getLoggers());
    }
    ...
    private static String[] getLoggers() {
        return new String[]{ DatasetGraphInMemoryCowTxn.class.getName() };
    }
