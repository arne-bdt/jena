...
/**
 * The Bifurcan-backed counterpart of {@link TestDatasetGraphInMemoryTransactions}.
 */
public class TestDatasetGraphInMemoryBifurcanTransactions extends AbstractTestTransactionLifecycle {
	...
	protected Dataset create() {
		return DatasetFactory.wrap(DatasetGraphFactory.createTxnMemBifurcan());
	}
}
