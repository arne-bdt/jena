...
public class TestDatasetGraphInMemoryCowTxnTransactions extends AbstractTestTransactionLifecycle {
    static Class<?> targetClassLogger = DatasetGraphInMemoryCowTxn.class;
    ...
    protected Dataset create() {
        return DatasetFactory.wrap(new DatasetGraphInMemoryCowTxn());
    }
}
