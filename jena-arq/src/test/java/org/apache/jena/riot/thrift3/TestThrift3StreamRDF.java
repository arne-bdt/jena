...
public class TestThrift3StreamRDF {

    private static final String DIR = TS_RDFThrift3.TestingDir ;
    ...
    @Test public void graph_01() {
        ...
        StreamRDF stream = Thrift3RDF.streamToOutputStream(out) ; // With values.
        ...
        Thrift3RDF.inputStreamToStream(in, stream2) ;
    ...
    @Test public void graph_02() {
        ByteArrayOutputStream out = new ByteArrayOutputStream() ;
        StreamRDFWriter.write(out, graph, Lang.RDFTHRIFT3, null) ;
        ...
        Graph g2 = GraphFactory.createGraphMem() ;
        RDFDataMgr.read(g2, in, Lang.RDFTHRIFT3) ;
        boolean b = IsoMatcher.isomorphic(graph, g2) ;
        assertTrue(b) ;
    ...
    @Test public void dataset_02() {
        DatasetGraph dsg1 = datasetGraph ;
        ByteArrayOutputStream out = new ByteArrayOutputStream() ;
        StreamRDFWriter.write(out, dsg1, Lang.RDFTHRIFT3) ;
