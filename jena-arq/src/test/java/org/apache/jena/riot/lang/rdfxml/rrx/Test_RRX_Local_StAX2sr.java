...
public class Test_RRX_Local_StAX2sr extends AbstractTestRDFXML_RRX {

    private static ReaderRIOTFactory rdfxmlStAXsrFactory = ReaderRDFXML_StAX2_SR.factory;
    ...
    public Test_RRX_Local_StAX2sr(String label, String filename) {
