...
public class Test_RRX_Local_StAX2sr_aalto extends AbstractTestRDFXML_RRX {

    private static ReaderRIOTFactory rdfxmlStAXsrFactory = ReaderRDFXML_StAX2_SR_aalto.factory;
    private static String implLabel = "StAX2(sr)_aalto";
    ...
    public Test_RRX_Local_StAX2sr_aalto(String label, String filename) {
