...
public class TestThrift2StreamRDF {

    private static final String DIR = TS_RDFThrift2.TestingDir ;
    ...
    @Test public void graph_01() {
        ...
        StreamRDF stream = Thrift2RDF.streamToOutputStream(out) ; // With values.
        ...
        Thrift2RDF.inputStreamToStream(in, stream2) ;
    ...
    @Test public void graph_02() {
        ByteArrayOutputStream out = new ByteArrayOutputStream() ;
        StreamRDFWriter.write(out, graph, Lang.RDFTHRIFT2, null) ;
        ...
        Graph g2 = GraphFactory.createGraphMem() ;
        RDFDataMgr.read(g2, in, Lang.RDFTHRIFT2) ;
        boolean b = IsoMatcher.isomorphic(graph, g2) ;
        assertTrue(b) ;
    ...
    @Test public void dataset_01() {
        ...
        ByteArrayOutputStream out = new ByteArrayOutputStream() ;
        StreamRDF stream = Thrift2RDF.streamToOutputStream(out) ;
