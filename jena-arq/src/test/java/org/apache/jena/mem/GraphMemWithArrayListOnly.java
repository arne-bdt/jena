...
/**
 * A graph implementation that uses an ArrayList to store triples.
 * This is a very simple implementation that is not optimized for any
 * specific use case, other than loading triples very fast.
 * Only Graph#add(Triple), size#Count() Graph#find() are implemented.
